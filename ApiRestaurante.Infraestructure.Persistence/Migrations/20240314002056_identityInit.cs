        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumberOfPeoplePerTable = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishesIngredients", x => new { x.IngredientId, x.DishesId });
                    table.ForeignKey(
                        name: "FK_DishesIngredients_Dishes_DishesId",
                        column: x => x.DishesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishesOrders", x => new { x.OrdersId, x.DishesID });
                    table.ForeignKey(
                        name: "FK_DishesOrders_Dishes_DishesID",
                        column: x => x.DishesID,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishesOrders_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishesIngredients_DishesId",
                table: "DishesIngredients",
                column: "DishesId");

            migrationBuilder.CreateIndex(
                name: "IX_DishesOrders_DishesID",
                table: "DishesOrders",
                column: "DishesID");
